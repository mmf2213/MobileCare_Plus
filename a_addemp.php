...
<center>
  ...
  <form id ="rform" action="" method="POST">
   ...
   <h1> Add new Employee </h2>
   <p><i>Enter new employee details below </i></p>
   <input type="text" name="name" id="name" value="" placeholder="Enter Employee Name"></br></br>
   <input type="text" name="cont" id="cont" maxlength="10" value="" placeholder="Enter Employee Contact No."></br></br>
